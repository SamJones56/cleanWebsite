...
<?php if ($_SESSION['permissionlvl'] > 2) { ?>
    ...
    <div>
        <form action="adminManageDepts.php" method="post">
            <button class="btn btn-light btn-lg btn-block btn btn-outline-success" type="submit">Manage departments
            </button>
        </form>
    </div>
    <br>
    ...
    <div>
        <form action="adminManageDiscounts.php" method="post">
            <button class="btn btn-light btn-lg btn-block btn btn-outline-success" type="submit">Manage Discounts
            </button>
        </form>
    </div>
    <br>
<?php } ?>
    <div>
        <form action="adminManageReservations.php" method="post">
            <button class="btn btn-light btn-lg btn-block btn btn-outline-success" type="submit">Manage Bookings
            </button>
        </form>
    </div>
    <br>

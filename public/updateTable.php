...
<div id="dataForm">
    <form method="post">
        ...
        <input type="text" name="table_id" id="table_id" value="<?php echo $editingTable['table_id'] ?>"
               class="form-control">

        <label for="capacity">Capacity</label>
        <input type="text" name="capacity" id="capacity" value="<?php echo $editingTable['capacity'] ?>"
               class="form-control">
        <br>
